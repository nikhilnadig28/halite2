...
bot_1 = '"test.py" ' #enter the bot1 file name. Maintain the format. 
bot_2 = '"test.py" ' #enter the bot2 file name. Maintain the format. 
bot_3 = '"test.py" ' #enter the bot3 file name. Maintain the format. 
bot_4 = '"test.py"'  #enter the bot4 file name. Maintain the format. 
...
for num in range(5000):
    try:
        ...
        os.system('halite.exe -d "360 240"' + bot_1 + bot_2 + bot_3 + bot_4 '>> match.results')
